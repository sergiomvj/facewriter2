...
export const InsertIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const BoldIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6v10H4V4h2zm2 2v4h6a2 2 0 0 0 2-2 2 2 0 0 0-2-2H8z" />
    </svg>
);

export const ItalicIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M10 4v2h2.55l-3.5 12H6v2h12v-2h-2.55l3.5-12H18V4z" />
    </svg>
);
...
export const GrammarIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 6.75l6 6 9-13.5" opacity="0.5" />
    </svg>
);
...
export const ShortenIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const UploadIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M3 17.25V17.25c0 .621 0 1.242.016 1.858a2.25 2.25 0 002.046 2.046A21.503 21.503 0 0012 21.75c.618 0 1.236 0 1.858-.016a2.25 2.25 0 002.046-2.046c.015-.616.016-1.237.016-1.858v-1.125a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 16.125v1.125z" />
    </svg>
);

export const TranslateIcon: React.FC<React.SVGProps<SVGSVGElement>> = props => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21l5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 016-.371m0 0c1.12 0 2.233.038 3.334.108m-3.334-.108a48.38 48.38 0 012.986.65m-2.986-.65a48.47 48.47 0 00-2.283-1.552 8.324 8.324 0 00-1.282.63M3 5.621a48.474 48.474 0 016-.371m0 0c.583.013 1.164.03 1.737.054M9 5.25a2.25 2.25 0 012.25-2.25h3.75a2.25 2.25 0 012.25 2.25M3 5.621a48.474 48.474 0 016-.371m0 0c.583.013 1.164.03 1.737.054M9 5.25a2.25 2.25 0 012.25-2.25h3.75a2.25 2.25 0 012.25 2.25m-9 3.75h9" />
    </svg>
);
...
export const SettingsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.95.54.056 1.007.52 1.066 1.11.06.582-.294 1.135-.836 1.398l-.055.027a.499.499 0 01-.488-.027c-.328-.213-.56-.632-.51-.998z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 110-18 9 9 0 010 18z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM21.75 9.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25a.75.75 0 110-1.5.75.75 0 010 1.5zM12 21.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.125 4.125a.75.75 0 11-1.06-1.06.75.75 0 011.06 1.06zM19.875 4.125a.75.75 0 111.06-1.06.75.75 0 01-1.06 1.06z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.125 19.875a.75.75 0 11-1.06 1.06.75.75 0 011.06-1.06zM19.875 19.875a.75.75 0 111.06 1.06.75.75 0 01-1.06-1.06z" />
  </svg>
);
